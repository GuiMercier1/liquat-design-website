...
let dictionary = {
    'en': {
        ...
        "INDEX_DESIGNER_TEXT": "I develop my creativity for your users in order to build useful, usables and attractive softwares.<br /><br />To learn more about UX Design : <a href='https://theblog.adobe.com/what-does-a-ux-designer-actually-do/' target='_blank'>click here.</a>",
        "INDEX_LEAD_TITLE": "Project leader",
        "INDEX_LEAD_TEXT": "I manage costs, deadlines and the quality of your projects while providing in house communication with our team and stakeholders.",
        "INDEX_PRODUCT_TITLE": "Product Owner",
        "INDEX_PRODUCT_TEXT": "Let's build together your product's strategy, and I take care of its achievement with the customers and the development team.",
        "INDEX_SPLUNK_TITLE": "Splunk Developer",
        "INDEX_SPLUNK_TEXT": "Let's exceed the limits of Splunk to create dynamic dashboards which present useful and usable data while following the \"data visualization\" precepts.",
        ...
        "PROJECTS_TAGS_PROJECT-MANAGEMENT": "Project Management",
        "PROJECTS_TAGS_WEB-DEV": "Web Dev",
        ...
        "RESUME_CONTACT_DATE": "May 2019 - Now",
        "RESUME_CONTACT_TEXT": "<ul><li>Development of custom Splunk Dashboards with JS.</li><li><a href='./contact?lang=en' target='_blank'>Contact me</a> for any of your projects ! </li></ul>",
        ...
        "RESUME_MATHSMASTER_TEXT": "Paul Sabatier, Toulouse",
        ...
        "FOOTER_GITHUB": "My mad experiments",
    ...
    'fr': {
        ...
        "RESUME_HTML_TITLE": "Expériences - Guillaume Mercier",
        "RESUME_TITLE": "Expériences",
        "RESUME_DOWNLOAD": "Mon CV (PDF)",
        "RESUME_CONTACT_TITLE": "Freelance",
        "RESUME_CONTACT_DATE": "Mai 2019 - Présent",
        "RESUME_CONTACT_TEXT": "<ul><li>Développement de dashboards Splunk personnalisés en JavaScript.</li><li><a href='./contact?lang=fr' target='_blank'>Contactez-moi</a> pour discuter de vos projets !</li></ul>",
        "RESUME_INOVANS_TITLE": "Inovans",
        "RESUME_INOVANS_DATE": "Sept. 2017 - Jan. 2019",
        ...
        "FOOTER_GITHUB": "Expériences plus ou moins réussies",

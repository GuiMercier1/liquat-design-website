...
let dictionary = {
    'fr': {
        ...
        "INDEX_TEAM_TEXT": "Prendre en compte les contraintes de temps, de budget, les contraintes techniques… je travaille main dans la main avec tous les acteurs du projet pour proposer des solutions réalistes et non pas une licorne à paillettes.",
        "INDEX_PSY_TITLE": "Background en psychologie",
        "INDEX_PSY_TEXT": "Mon master en psychologie me permet de recueillir des informations en influençant au minimum les utilisateurs, mes connaissances dans la prise de décision, l'attention ou encore le traitement de l'information soutiennent mes propositions d'interfaces, bref",
